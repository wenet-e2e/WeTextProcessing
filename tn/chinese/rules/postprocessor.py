...
class PostProcessor(Processor):
    ...
    def __init__(self, remove_interjections=True, remove_puncts=False, full_to_half=True, tag_oov=False):
        ...
        full2half = string_file(get_abs_path("chinese/data/char/fullwidth_to_halfwidth.tsv"))
        zh_charset_std = string_file(get_abs_path("chinese/data/char/charset_national_standard_2013_8105.tsv"))
