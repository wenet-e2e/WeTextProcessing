...
class Cardinal(Processor):
    ...
    def build_tagger(self):
        ...
        graph = (
            pynini.closure(self.DIGIT, 1, 3) + ((pynutil.delete(",") + self.DIGIT**3).star | (self.DIGIT**3).star)
        ) @ graph
        ...
        if self.deterministic:
            ...
            cardinal_with_leading_zeros = (
                leading_zeros + self.INSERT_SPACE + pynini.compose(self.DIGIT.star, self.graph_with_and)
            )
        ...
        optional_minus_graph = (pynutil.insert("negative: ") + pynini.cross("-", '"true" ')).ques
    ...
    def build_verbalizer(self):
        ...
        self.integer = self.DELETE_SPACE + pynutil.delete('"') + integer + pynutil.delete('"')
